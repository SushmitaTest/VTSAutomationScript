...
public class  VehicleTimeWise extends  baseLoginTest   {
	
	@Test
	public void VehicleTimeWise() throws InterruptedException
	{
	     ...
	     WebElement VehicleTimeWise = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("ctl00_liVehiclewiseTimeWDistance")));
	     VehicleTimeWise.click();
