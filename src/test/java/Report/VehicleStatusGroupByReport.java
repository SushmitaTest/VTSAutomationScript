...
public class VehicleStatusGroupByReport extends baseLoginTest {
		@Test
			...
			Thread.sleep(3000);
			WebElement VehicleStatusGroup = wait.until(ExpectedConditions.elementToBeClickable(By.id("ctl00_liVTSVehicleStatusReportGroupBy")));
			VehicleStatusGroup.click();
