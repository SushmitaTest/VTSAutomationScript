...
public class VehicleStatusSummaryReport extends baseLoginTest {
	@Test
	public void VehicleStatusGroup() throws InterruptedException, IOException
	{
    ...
    Report.click();
	    ...
	    Thread.sleep(3000);
		WebElement VehicleStatusSummary= wait.until(ExpectedConditions.elementToBeClickable(By.id("ctl00_liVTSVehicleStatusSummaryReport")));
		VehicleStatusSummary.click();
